...
export function FinalCTA() {
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-x-0 top-0 h-24 bg-gradient-to-b from-[#252A30]/35 to-transparent"
      />
      ...
      <div className="mes-container relative">
        <div className="grid gap-14 lg:grid-cols-[minmax(0,0.75fr)_minmax(32rem,1.25fr)] lg:gap-20">
          <div>
            ...
            >
              Let&apos;s build on what you&apos;ve started.
            </h2>

            <p className="mt-8 max-w-lg text-base leading-8 text-white/50">
              Share the details that matter. We&apos;ll start with the context
              you&apos;ve already provided and work from there.
            </p>
