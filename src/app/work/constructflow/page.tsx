...
export const metadata: Metadata = {
  ...
  description:
    "See how MES designed ConstructFlow, a construction management platform for projects, daily logs, RFIs, change orders, documents, and field operations.",
  ...
  openGraph: {
    title: "ConstructFlow Case Study | MES",
    description:
      "A construction management platform designed around the way construction teams actually work.",
          ...
          <div className="mt-12 grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-end lg:gap-20">
            ...
            <div className="max-w-xl lg:justify-self-end">
              <p className="text-base leading-8 text-white/48">
                ConstructFlow was designed to replace disconnected spreadsheets,
                paperwork, and manual communication with one clear workspace for
                managing construction projects and day-to-day operations.
              </p>
            ...
            <div className="grid gap-0 border-t border-white/[0.08]">
              <article className="grid gap-4 border-b border-white/[0.08] py-8 sm:grid-cols-[3rem_1fr] sm:gap-6">
                ...
                <div>
                  ...
                  <p className="mt-3 max-w-2xl text-sm leading-7 text-white/45 sm:text-base sm:leading-8">
                    The dashboard was designed to surface the information teams
                    need most often—project status, priorities, budget signals,
                    tasks, and recent activity—without forcing users to dig
              ...
              <article className="grid gap-4 border-b border-white/[0.08] py-8 sm:grid-cols-[3rem_1fr] sm:gap-6">
                ...
                <div>
                  ...
                  <p className="mt-3 max-w-2xl text-sm leading-7 text-white/45 sm:text-base sm:leading-8">
                    RFIs and change orders were treated as structured workflows
                    instead of loose notes, making their status and impact
